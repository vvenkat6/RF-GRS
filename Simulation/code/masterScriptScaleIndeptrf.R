...
# Output results
split = 0.5
write.table(cbind(modelN,causalN,seed,split,strength,trf1.nr2,trf.nr2),file="/home3/DrYao/FINALest/Simulation/NR2Indeptrf",quote=FALSE,row.names=FALSE,col.names= !file.exists("/home3/DrYao/FINALest/Simulation/NR2Indeptrf"),append=T)
